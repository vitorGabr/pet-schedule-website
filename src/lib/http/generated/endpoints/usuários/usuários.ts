...
export const listCompanyClients = (
	...
	return customFetch<ListCompanyClientsResponseDtoOutput>(
		{ url: `/users/company/clients`, method: "GET", params },
		options,
	);
};
...
export const getListCompanyClientsQueryKey = (
	...
	return [`/users/company/clients`, ...(params ? [params] : [])] as const;
};
...
>(
	...
	const queryKey =
		queryOptions?.queryKey ?? getListCompanyClientsQueryKey(params);

	const queryFn: QueryFunction<
		Awaited<ReturnType<typeof listCompanyClients>>
	> = () => listCompanyClients(params, requestOptions);
...
>(
	...
	const queryOptions = getListCompanyClientsQueryOptions(params, options);
