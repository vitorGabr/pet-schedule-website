							...
							<div className="flex items-start gap-3">
								...
								<div className="text-sm">
									...
									<p className="text-amber-700">
										O tempo e valor do serviço podem variar dependendo do porte
										do animal, idade, comportamento e condições específicas. O
										valor final será confirmado após avaliação do profissional.
									</p>
								</div>
							</div>
						</div>
